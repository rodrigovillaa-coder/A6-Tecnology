    ...
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-6">
        ...
        <div className="relative mb-24 overflow-hidden rounded-3xl bg-slate-50 py-12 border border-slate-100 shadow-inner">
          {/* Degradê de desvanecimento para efeito visual suave */}
          <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 bg-gradient-to-r from-slate-50 to-transparent"></div>
          <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 bg-gradient-to-l from-slate-50 to-transparent"></div>
          ...
          <div className="flex w-full overflow-hidden">
            ...
            >
              {[...Array(2)].map((_, containerIdx) => (
                <div key={containerIdx} className="flex gap-16 md:gap-24 items-center shrink-0 pr-16 md:pr-24">
                  {[
                    ...
                    <div
                      key={idx}
                      className="flex h-12 w-32 md:w-36 items-center justify-center shrink-0"
                    >
                      <img
                        src={brand.src}
                        alt={brand.alt}
