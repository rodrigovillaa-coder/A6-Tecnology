  ...
  return (
    <header 
      className={`fixed top-0 z-50 w-full transition-all duration-300 ${
        scrolled ? "bg-white/90 py-3 shadow-md backdrop-blur-md" : "bg-transparent py-6"
      }`}
    >
      <div className="container mx-auto flex items-center justify-between px-6">
        <Link to="/" className="flex items-center gap-2">
          <img 
            src={scrolled ? "https://lh3.googleusercontent.com/d/1ZZXALGSbXcM4p489tEl0p0CjB3N13yzQ" : "https://lh3.googleusercontent.com/d/1GKH4AcEqVl3ecalSO0COPXv7jrlZhBNm"} 
            alt="A6 Tecnology Logo" 
            className="h-[50px] md:h-[70px] w-auto transition-all duration-300"
          />
        </Link>
        ...
        <nav className="hidden md:flex md:items-center md:gap-8">
          {NAV_LINKS.map((link) => (
            <a 
              ...
              className={`text-sm font-medium transition-colors hover:text-primary ${
                scrolled ? "text-neutral-gray" : "text-white/80"
              }`}
            >
              {link.name}
            </a>
          ...
          <a 
            ...
            className="rounded-full bg-primary px-6 py-2 text-sm font-semibold text-white transition-transform hover:scale-105 active:scale-95 text-center flex items-center justify-center"
          >
            Orçamento
          </a>
        </nav>
          ...
          <div className="flex flex-col gap-4">
            ...
            {NAV_LINKS.map((link) => (
              <a 
                key={link.name} 
                href={link.href}
                className="text-lg font-medium text-neutral-gray"
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="mt-4 rounded-lg bg-primary py-3 font-semibold text-white text-center block"
              onClick={() => setIsMenuOpen(false)}
            >
              Solicitar Orçamento
            </a>
        ...
        <div className="container mx-auto px-6">
          <div className="mb-12 md:mb-16 text-center">
            ...
            <div className="mt-10 md:mt-12 flex flex-wrap justify-center gap-6 md:gap-16">
              {[
                { 
                  img: "https://lh3.googleusercontent.com/d/1TqZG2NKTtbQGlDQpCOsxaAIIVvJrWRIV", 
                  label: "Impressora monocromática" 
                },
                { 
                  img: "https://lh3.googleusercontent.com/d/1TDiDzqRotnD0CQhyLdpZsKTENI1FKznv", 
                  label: "Impressora colorida" 
                },
                { 
                  img: "https://lh3.googleusercontent.com/d/19ilQw-RPO_4__S5zS-E2EZ_KiwRBNRmh", 
                  label: "Multifuncional monocromática" 
                },
                { 
                  img: "https://lh3.googleusercontent.com/d/1lAimit38wkyTcV2KNCZN43zDP9oK49z5", 
      ...
      <section id="papelaria" className="bg-slate-50 py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center justify-between gap-12 lg:flex-row">
            ...
            <div className="relative w-full lg:w-1/2">
              <img 
                src="https://lh3.googleusercontent.com/d/1firWZ8VDrRIfhay99y8AnPYw7Q5nSXOc" 
                alt="Papelaria Corporativa A6" 
                className="w-full rounded-2xl shadow-2xl"
                referrerPolicy="no-referrer"
              />
