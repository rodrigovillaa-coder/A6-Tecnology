        ...
        <div className="container mx-auto px-6">
          <div className="mb-12 md:mb-16 text-center">
            ...
            <div className="mt-10 md:mt-12 flex flex-wrap justify-center gap-6 md:gap-16">
              {[
                { 
                  img: "https://a6technology.com.br/assets/impressora-icon-1.png", 
                  label: "Impressora monocromática" 
                },
                { 
                  img: "https://a6technology.com.br/assets/impressora-icon-2.png", 
                  label: "Impressora colorida" 
                },
                { 
                  img: "https://a6technology.com.br/assets/impressora-icon-3.png", 
                  label: "Multifuncional monocromática" 
                },
                { 
                  img: "https://a6technology.com.br/assets/impressora-icon-4.png", 
                  label: "Multifuncional colorida" 
                },
                { 
                  img: "https://a6technology.com.br/assets/impressora-icon-5.png", 
                  label: "Impressora A3" 
                },
                { 
                  img: "https://a6technology.com.br/assets/impressora-icon-6.png", 
      ...
      <section id="papelaria" className="bg-slate-50 py-16 md:py-24">
        <div className="container mx-auto px-6">
          <div className="flex flex-col items-center justify-between gap-12 lg:flex-row">
            ...
            <div className="relative w-full lg:w-1/2">
              <img 
                src="https://a6technology.com.br/assets/papelaria-a6.jpg" 
